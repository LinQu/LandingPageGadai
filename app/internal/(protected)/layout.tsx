...
import { Archive, BrainCircuit, BriefcaseBusiness, FileText, Layers, LayoutDashboard, MessageCircle, Package, Wrench } from 'lucide-react'
...
const menu = [
  ...
  { href: '/internal/live-chat', label: 'Live Chat', icon: MessageCircle },
