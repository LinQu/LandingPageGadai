...
function Shell({ children }: { children: React.ReactNode }) { return <main className="min-h-screen bg-slate-100"><header className="bg-primary"><div className="site-container flex h-16 items-center"><img src="/logo.png" alt="Gadai Sakti" className="block h-auto w-[154px] object-contain sm:w-[168px] lg:w-[188px]" /></div></header><div className="site-container py-8 md:py-12"><div className="mx-auto max-w-6xl">{children}</div></div></main> }
